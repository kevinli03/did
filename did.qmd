...
**did** is a package that implements the DiD estimators proposed by Callaway and Sant'Anna (2021) that solve the bias of the TWFE estimator in staggered DiD. Documentation can be found [here](https://bcallaway11.github.io/did/index.html).
