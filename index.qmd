...
This repository is a collection of resources on Difference-in-Differences (DiD) and implementation in **R** and **Python** (and Julia coming soon). Use the left sidebar to navigate between pages.
